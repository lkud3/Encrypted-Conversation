...
let = ["A", "Б", "В", "Г", "Д", "Е", "Ж", "З", "И", "Й", "К", "Л", "М", "Н", "О", "П", "Р", "С", "Т", "У", "Ф", "Х", "Ц", "Ч", "Ш", "Щ", "Ь", "Ы", "Ъ", "Э", "Ю", "Я"]
...
def rsa_decrypt(S, d, N):
    ...
    for i in range(0, len(S), 5):
      ...
      num = pow(num, d, N)
      text += let[find(cod, num)]
    return text
"""
def rsa_encrypt(S, E, N):
    return str([pow(ord(i), E, N) for i in S]).encode()
    
def rsa_decrypt(S, d, N):
    return [chr(pow(int(i), d, N)) for i in eval(S)]
